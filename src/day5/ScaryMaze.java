...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	BufferedImage maze;
	final int frameWidth = 1120;
	final int frameHeight = 980;
...
int fell=0;
		...
		if (mouseColor==fell) {scare();}
				// call the scare method
		
		//10. if the mouse is on the end color
				if (mouseColor == -1644960) { JOptionPane.showMessageDialog(null, "You won! The story of your feat is remembered for hundreds of years.");}
...
showScaryImage();
	...
	private void showScaryImage() {
		try {
			maze = ImageIO.read(getClass().getResource("boo.png"));
		} catch (Exception e) {
System.err.println("Couldn't find this image: " +"boo.png");}
		repaint();
	}
